/*
	Canbuss.h
	2017 Copyright (c) MalieTech All right reserved.
	
	Author:pivooo
	2017-4-7
	
	LICENSE TO ADD SOON TM
*/
...
#define CAN_SELECT()   digitalWrite(CAN_CS, LOW)
#define CAN_UNSELECT() digitalWrite(CAN_CS, HIGH)
